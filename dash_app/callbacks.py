...
def register_callbacks(app):
    ...
    def update_graphs(start_date, end_date):
        ...
        gauge_fig.update_layout(height=300, width=300, margin=dict(l=20, r=20, t=20, b=20))

        # Balkendiagramm erstellen
        bar_fig = px.bar(df_grouped, x='Kurztext', y='Erfasste Menge',
                         title=f'Tage Faktura nach Projekt', labels={'Kurztext': 'Projekt'},
